...
namespace Day8
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //publisher.NewBookPublished += new Publisher.SampleEventHandler ( delegate(object sender, SampleEventArgs e) 
            //{
            //    Console.WriteLine("Da nhan thong bao tu phia Publisher - client 3!");
            //    Console.WriteLine(e.Text); 
            //});

            publisher.NewBookPublished += ((s, e) =>
            {
                Console.WriteLine("Da nhan thong bao tu phia Publisher - client 4!");
                Console.WriteLine(e.Text);
            });
